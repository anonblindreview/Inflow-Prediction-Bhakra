...
import math
import numpy as np
month=#int(input("enter the month number: "))-1
X_t= #int(input("inflow data: "))
number_of_months=#int(input("Enter the number of months for which you want predictions"))
#mean
...
for i in range(number_of_months):
    ...
    X_t1=u[(month+1)]+z_t1*sd[(month+1)]
